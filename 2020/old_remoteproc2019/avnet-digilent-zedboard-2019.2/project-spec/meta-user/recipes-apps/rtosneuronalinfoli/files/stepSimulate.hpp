...
*/
	...
	memset(&(local_state[neuron].axon),(int)local_state[neuron].axon,size);
	bytes_sent = write(fd,local_state[neuron].axon,(2 * sizeof(unsigned long)) + size);


	printf("Neuron: %i\n",neuron);
	printf("V_axon = %f\n",local_state[neuron].axon.V_axon);
	printf("Sodium_m_a = %f\n",local_state[neuron].axon.Sodium_m_a);
	printf("Sodium_h_a = %f\n",local_state[neuron].axon.Sodium_h_a);
	printf("Potassium_x_a = %f\n",local_state[neuron].axon.Potassium_x_a);
